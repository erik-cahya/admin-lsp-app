...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <form enctype="multipart/form-data" method="POST" action="/manajemen">
            @csrf
               <!-- start page title -->
               <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Create Data {{ $titlePage }}</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Create Data {{ $titlePage }}</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="header-title">Form Create Data {{ $titlePage }}</h4>
                                    <p class="text-muted mb-0">
                                        Inputkan data {{ $titlePage }} pada form dibawah | <code> Anda dapat juga meng-upload foto dan tanda tangan untuk mempermudah keperluan administrasi</code>
                                    </p>
                                </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Inputkan Nama Manajemen" name="nama_manajemen">
                                                </div>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <img src="{{ asset('velonic_admin/assets/images/users/avatar-2.jpg') }}" class="foto_manajemen img-thumbnail" width="200px">
                                            </div>
